# Contributing to inrlbots(fasweeh)
...
3. Increase the version numbers in any examples files and the README.md to the new version that this
   Pull Request would represent. The versioning scheme we use is [ReadMe](https://github.com/fasweeh-mvr/inrlbots/blob/master/README.md).
